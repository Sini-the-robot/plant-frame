...
def get_image_url(image_prompt):
    encoded = quote(image_prompt)
    seed = random.randint(1, 99999)
    return f"https://image.pollinations.ai/prompt/{encoded}?width=800&height=1100&seed={seed}&nologo=true"
...
<style>
  *{{ margin:0; padding:0; box-sizing:border-box; }}
  ...
  .weather-row{{
    ...
    gap:0.3rem; margin-bottom:1.4rem;
  ...
  .plant-note{{ font-size:0.88rem; font-style:italic; line-height:1.65; color:rgba(242,236,224,0.4); margin-bottom:1.3rem; animation:slideUp 1s ease forwards; }}
  ...
  .compound-desc{{ font-family:'DM Mono',monospace; font-size:0.58rem; line-height:1.55; color:rgba(242,236,224,0.28); margin-bottom:1.2rem; }}
